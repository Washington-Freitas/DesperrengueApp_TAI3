...
## O Problema
Atualmente, as maiores plataformas do mercado (como GetNinjas) utilizam modelos de negócios que punem o prestador de serviço: eles precisam comprar "moedas" ou créditos apenas para ter o direito de enviar um orçamento, sem garantia de fechamento do negócio. Para o cliente final, há a insegurança de colocar um desconhecido dentro de casa sem a devida triagem prévia.

## A Solução
Um aplicativo de marketplace mobile, com foco em serviços residenciais, baseado em um modelo de "Oferta Direcionada". O cliente publica a sua necessidade (ex: vazamento hidráulico), e o algoritmo notifica os profissionais mais qualificados da região. Até 3 profissionais enviam seus orçamentos gratuitamente. A plataforma garante segurança através de verificação documental dos profissionais e lucra apenas retendo uma comissão caso o serviço seja de fato fechado através do aplicativo.
...
Nossa fundação estratégica garante que as operações e o desenvolvimento da plataforma estejam sempre alinhados com o objetivo de gerar valor real para a sociedade.
