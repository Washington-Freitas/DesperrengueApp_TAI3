...
* [📖 Documento de Contexto](./docs/Documento%20de%20Contexto.md) (Contém o Problema, Solução, Lean Canvas e Missão, Visão e Valores)
* [📋 Especificação do Projeto](./docs/Especificação%20do%20Projeto.md) (Contém as Personas, Histórias de Usuário, Requisitos Funcionais/Não-Funcionais e Restrições)
